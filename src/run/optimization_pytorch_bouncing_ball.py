...
from src.pytorch.dae_optimizer_pytorch import BouncingBallModel, DAEOptimizerPyTorch
...
def run_bouncing_ball_test(config: dict):
    ...
    try:
        ...
        plt.tight_layout()
        plot_path = os.path.join(root_dir, 'results', 'optimization_result_pytorch_bouncing_ball.png')
